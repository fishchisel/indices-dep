...
import webglInputManager from '../Input/webglInputManager.js'
import webglLinkProgram from '../WebGL/webglLinkProgram.js'
import webglNodeProgram from '../WebGL/webglNodeProgram.js'
import webglSquare from '../WebGL/webglSquare.js'
import webglLine from '../WebGL/webglLine.js'
 ...
 *  formatNode - a function to set the size and color of the node. If not set there 
 *               is a default format.
 */
...
function webglGraphics(options) {
    options = merge(options, {
        ...
        formatNode: (node) => ({size: 10, color: 0x009ee8ff})
    });
...
/*jshint unused: false */
        nodeUIBuilder = options.formatNode,
