...
import forceDirected from 'ngraph.forcelayout'
//import svgGraphics from './svgGraphics.js'
import windowEvents from '../Utils/windowEvents.js'
import domInputManager from '../Input/domInputManager.js'
import timer from '../Utils/timer.js'
import getDimension from '../Utils/getDimensions.js'
import dragndrop from '../Input/dragndrop.js'
...
function renderer(graph, settings) {
  ...
  var layout = settings.layout,
    ...
    zoomSpeed = settings.zoomSpeed || 0.2,
  ...
  function scale(out, scrollPoint) {
    ...
    var scaleFactor = Math.pow(1 + 0.4, out ? -zoomSpeed : zoomSpeed);
